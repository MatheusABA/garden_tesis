...
class HourlyMatrix(BaseModel):
    ...
    correlation_matrix: Optional[List[float]] = None # Correlação entre as variáveis
    sensor_mean: Optional[float] = None # Valores médios das medições dos sensores - Pode ter valor nulo
